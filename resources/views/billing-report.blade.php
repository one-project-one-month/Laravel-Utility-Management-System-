...
<head>
    ...
    <title>Monthly Utility Statement</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>
                We hope you are enjoying your stay. Below is your detailed statement for this month.
                Please review the following breakdown of your utility and service charges.
            </p>
            ...
            <div class="due-date">
                ...
                <strong>{{ \Carbon\Carbon::parse($due_date)->format('d M Y') }}</strong>.
            </div>
